 ...
 */
class AlgoliaSuggestionSearchQueryPlugin extends AbstractPlugin implements QueryInterface, SearchContextAwareQueryInterface, SearchStringSetterInterface, QueryApplicabilityCheckerInterface, SearchTypeIdentifierInterface
{
    ...
    /**
     * {@inheritDoc}
     * - Returns SearchQueryTransfer for Algolia suggestion search.
     *
     * @api
     */

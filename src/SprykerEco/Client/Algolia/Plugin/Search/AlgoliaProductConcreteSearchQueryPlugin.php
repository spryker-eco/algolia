 ...
 */
class AlgoliaProductConcreteSearchQueryPlugin extends AbstractPlugin implements SearchContextAwareQueryInterface, SearchStringSetterInterface, QueryInterface, QueryApplicabilityCheckerInterface, SearchTypeIdentifierInterface
{
    ...
    {
        return AlgoliaConfig::TYPE_PRODUCT_CONCRETE_SEARCH_HTTP;
    }
}
